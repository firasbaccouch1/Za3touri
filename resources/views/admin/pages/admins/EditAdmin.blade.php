            ...
            <div class="row ">
                ...
                <div class='col-sm-12 '>
                    <div class="text-center">
                      ...
                      @endforeach 
                      <form class="user" method="POST" action="{{ route('Admins.update',$admin->id) }}" enctype="multipart/form-data" >
                        @csrf
                        @method('PATCH')
                        ...
                        <div class="form-group row text-center justify-content-center">
                          <div class="col-lg-8 ">
                            ...
                            <input type="text" value="{{ $admin->email }}" name="email" class="form-control form-control-user"  >
                            <br>
                          </div>
                        </div>
                        <div class="form-group row text-center justify-content-center">
                          <div class="col-lg-8 ">
                            ...
                            <select name="roles[]" class="form-control form-control-user text-center" multiple style="border-radius: 50px;height: 90px">
                              ...
                              <option  value={{ $role->name }} {{ $admin->HasRole($role)?'selected':'' }} class="badge badge-pill badge-{{ $role->name == 'owner'?'warning':'secondary' }}" style="padding: 10px"> <span >{{ $role->name }} </span></option>
