                   ...
                   <div class="form-group row text-center justify-content-center">
                          <div class="col-lg-8 ">
                            ...
                            <select @change="onchange($event)"  class="form-control form-control-user text-center selectionstyle" multiple >
                              <option :selected="Discount.category_id !=null " value="Category" > Category </option>
                              <option :selected="Discount.product_id !=null" value="Product" > Product </option>
                          </select>
                            <br>
                          </div>
                        </div>
                        <div v-if="Categories != null" class="form-group row text-center justify-content-center">
                          <div class="col-lg-8 ">
                            ...
                            <select name="category" class="form-control text-center">
                                <option :selected='categoryselected(Category.id)'  v-for="Category in Categories" :key="Category.length" :value="Category.id"  > {{ Category.name }} </option>
                              </select>
                            <br>
                          </div>
                        </div>
                        <div v-if="Products != null" class="form-group row text-center justify-content-center">
                          <div class="col-lg-8 ">
                            ...
                            <select name="product" class="form-control text-center">
                                <option :selected='productselected(Product.id)'  v-for="Product in Products" :key="Product.length" :value="Product.id"> {{ Product.name }} </option>
                              </select> 
                            <br>
                          </div>
                        </div>
...
<script>
    export default {
        ...
        methods:{
               categories() {
                  axios.get('/admin/categories/all/'+this.Discount.category_id)
                        .then(res => {
              ...
              products(){
                     axios.get('/admin/products/all/'+this.Discount.product_id)
                        .then(res =>{
            ...
            onchange(event){
               if (event.target.value == 'Category') {
                if (this.Discount.category_id != null) {
                   this.categories();
                   ...
                   if (this.Discount.product_id != null) {
                   this.products();
                }else{
              ...
              productselected($id) {
    if (this.Discount.product_id == $id) {
      return  true;
    }else{
       return false;
     }
                 ...
                 categoryselected($id) {
    if (this.Discount.category_id == $id) {
      return  true;
    }else{
       return false;
     }
